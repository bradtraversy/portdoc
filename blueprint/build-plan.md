...
- [ ] 13b. **Ignore service** - hide a service from the dashboard, persisted in local config. Depends on the config-storage decision (location/format still open); build after 13a once that is settled.
